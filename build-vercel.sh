...
cp index.html about.html waitlist.html tile-world-preview.html game.js resource-icons.js style.css sprite-map.html sprite-viewer-all.html .vercel-static/
