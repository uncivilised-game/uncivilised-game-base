...
| `scripts/feedback-digest.py` | Daily AI-summarised feedback digest posted as a GitHub issue |
...
- `.github/workflows/feedback-digest.yml` — daily (8am UTC) + manual. Queries recent feedback, generates an AI-summarised digest, and posts it as a GitHub issue. Inputs: `lookback_hours`, `dry_run`. Runs `scripts/feedback-digest.py`.
