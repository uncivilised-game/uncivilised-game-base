...
export const CIVICS = [
  ...
  { id: 'games_recreation', name: 'Games & Recreation', cost: 35, desc: '+2 Happiness from Arenas', unlocks: [], requires: ['state_workforce', 'military_tradition'], category: 'culture', inspiration: { condition: 'build_arena', description: 'Build an Arena' } },
