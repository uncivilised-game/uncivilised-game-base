...
export let UNIT_TYPES = {
  ...
  worker:    { name: 'Worker',        cost: 30, combat: 0,  rangedCombat: 0, range: 0, movePoints: 2, icon: '👷', class: 'civilian', buildCharges: 3, desc: 'Builds improvements on tiles (3 charges)' },
  ...
  great_general: { name: 'Great General', cost: 0, combat: 0, rangedCombat: 0, range: 0, movePoints: 2, icon: '\u{2694}', class: 'civilian', desc: 'Inspires nearby units. Can activate for +5 combat to all units for 10 turns.' },
};
...
// Worker unit type
export const WORKER_TYPE = { name: 'Worker', cost: 30, combat: 0, rangedCombat: 0, range: 0, movePoints: 2, icon: '👷', class: 'civilian', buildCharges: 3, desc: 'Builds tile improvements (3 charges)' };
...
export let UNIT_TYPES = {
  ...
  galley:    { name: 'Galley', cost: 35, combat: 25, rangedCombat: 0, range: 0, movePoints: 3, icon: '\u{26F5}', class: 'naval', desc: 'Coastal patrol vessel' },
  phalanx:   { name: 'Phalanx', cost: 40, combat: 30, rangedCombat: 0, range: 0, movePoints: 2, icon: '\u{1F6E1}', class: 'anti-cav', desc: 'Heavy infantry, +15 vs cavalry' },
  great_general: { name: 'Great General', cost: 0, combat: 5, rangedCombat: 0, range: 0, movePoints: 2, icon: '\u{2694}', class: 'civilian', desc: 'Inspires nearby units. Can activate for +5 combat to all units for 10 turns.' },
};
