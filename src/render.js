...
import { getTileYields, getTileName, getTileMoveCost, crossesRiver, roadBridgesRiver } from './map.js';
import { computeMoveRange, computeRiverCrossings, computeAttackRange } from './units.js';
